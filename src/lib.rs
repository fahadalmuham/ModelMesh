...
#[derive(Debug)]
pub struct ModelMeshProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModelMeshProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModelMesh processing");
    
    let mut processor = ModelMeshProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModelMeshProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModelMeshProcessor::new(false);
